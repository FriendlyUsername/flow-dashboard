...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "bg-card text-card-foreground relative w-72 rounded-md border",
      "hover:shadow-dp-2-brand-2",
...
>(({ className, ...props }, ref) => (
  <header
    ...
    {...props}
    className={cn(
      "font-body-medium-small flex flex-row justify-between gap-2 pr-4 pb-2 pl-[18px]",
...
>(({ className, ...props }, ref) => (
  <div
    ...
    className={cn(
      "font-body-p-xs flex flex-col gap-y-2 pr-4 pl-[18px]",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ...
    className={cn("flex flex-row justify-between pr-4 pl-[18px]", className)}
    {...props}
  />
));
